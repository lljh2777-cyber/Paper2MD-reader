...
} from "../model/mineru-caption-recovery";
import { Diagnostic, LoadedAsset, LoadedPaperPackage, NormalizedBBox } from "../model/reader-contract";
import type { PdfPageRenderResult, PdfReferenceRuntime } from "./pdf-reference-pane";
import {
  applyRecoveredParagraph,
  applyRecoveredText,
  recoverMinerUParagraph,
  recoverReplacementCharacters
} from "../model/mineru-text-recovery";
