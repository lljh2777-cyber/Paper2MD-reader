...
const ENGLISH = {
  ...
  webPdfEmptyCopy: "Open an original PDF, a Paper2MD or MinerU result folder, a standalone Markdown document, or a saved paper package. Content stays local to this browser.",
  ...
  pdfOnlyReady: "PDF · read-only",
  pdfOnlyTitle: "Original PDF opened read-only",
  pdfOnlyCopy: "The PDF is rendered directly in the reference pane. No Markdown is generated and the source file is not changed.",
  selectedPdfDocumentOpenFailed: "The selected PDF could not be opened in read-only mode.",
...
const CHINESE: Record<ReaderMessageKey, string> = {
  ...
  webPdfEmptyCopy: "可打开原始 PDF、Paper2MD / MinerU 结果文件夹、Markdown 文档或已保存的论文包；内容仅在当前浏览器本地读取。",
  ...
  openPdfFile: "打开 PDF",
  pdfOnlyReady: "PDF · 只读",
  pdfOnlyTitle: "已以只读模式打开原始 PDF",
  pdfOnlyCopy: "PDF 直接显示在参考栏中；不会生成 Markdown，也不会改动源文件。",
  selectedPdfDocumentOpenFailed: "无法以只读模式打开所选 PDF。",
