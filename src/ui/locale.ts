...
const ENGLISH = {
  ...
  openWebClipping: "Import web clipping",
  selectedWebClippingOpenFailed: "The web clipping could not be opened. Select one Markdown or HTML document with its local image files.",
