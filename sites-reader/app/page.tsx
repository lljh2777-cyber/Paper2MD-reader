...
export default function Home() {
  ...
  return (
    <main className="site-home">
      <header className="site-nav"><a className="site-brand" href="#top" aria-label="After-MinerU 首页">After‑<span>MinerU</span><small>by Paper2MD</small></a><nav aria-label="主要导航"><a href="/repair">修复 MinerU</a><a href="#precision">精准转换</a><a className="site-nav-local" href="/reader">打开 Reader</a><a href="#clipper">网页剪藏</a><a href="#desktop">下载桌面版</a><a href="#docs">文档</a></nav></header>
      ...
      <section className="site-entry-grid" aria-label="工作台入口"><a href="#quick"><span>01</span><b>快速转换</b><small>本地文本投影可用；MinerU Agent 暂停</small></a><a href="#precision"><span>02</span><b>精准转换</b><small>Chrome 商店版 0.2.0 已正式发布</small></a><a href="/reader"><span>03</span><b>打开本地论文</b><small>目录、Markdown、Paper2MD / .mineru.zip</small></a><a href="#clipper"><span>04</span><b>网页剪藏</b><small>开发者版 Companion 导出 ZIP</small></a><a href="#desktop"><span>05</span><b>下载桌面版</b><small>安全凭据、索引与长期论文库</small></a><a href="#docs"><span>06</span><b>使用文档</b><small>能力、隐私与兼容性说明</small></a></section>
